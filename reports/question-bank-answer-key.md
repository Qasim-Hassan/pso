...
## NSTC 2022 Biology Paper

| No. | Section | Page | Answer | Source | Prompt |
| --- | --- | --- | --- | --- | --- |
| 1 | Part I | - | C | Authored from standard science reasoning after paper text review | In multicellular organisms, similar cells are organized into groups, called |
| 2 | Part I | - | C | Authored from standard science reasoning after paper text review | The process by which one diploid cell divides to generate four haploid daughter cells is called |
| 3 | Part I | - | B | Authored from standard science reasoning after paper text review | Red blood cells are also called erythrocytes and transport |
| 4 | Part I | - | B | Authored from standard science reasoning after paper text review | A series of hypothesis supported by the results of many tests is called |
| 5 | Part I | - | A | Authored from standard science reasoning after paper text review | Artificial cleaning of blood is known as |
| 6 | Part I | - | A | Authored from standard science reasoning after paper text review | Which acid is present in vinegar? |
| 7 | Part I | - | A | Authored from standard science reasoning after paper text review | Which metal exist in fluid form at standard temperature and pressure conditions? |
| 8 | Part I | - | D | Authored from standard science reasoning after paper text review | Which one is not the contribution of Dalton in Chemistry? |
| 9 | Part I | - | A | Authored from standard science reasoning after paper text review | What is the empirical formula of Urea? |
| 10 | Part I | - | C | Authored from standard science reasoning after paper text review | Which vitamin is known as ascorbic acid? |
| 11 | Part I | - | C | Authored from standard science reasoning after paper text review | If 𝑎 ∗ b = a-b+ab, then 2 ∗ 5 + 5 ∗ 2 is |
| 12 | Part I | - | C | Authored from standard science reasoning after paper text review | Which of the fractions below is closest to 1? |
| 13 | Part I | - | D | Authored from standard science reasoning after paper text review | 62 + \|6\| + \|−6\| − 62 is equal to |
| 14 | Part I | - | B | Authored from standard science reasoning after paper text review | 5^5 / 5^4 is equal to |
| 15 | Part I | - | A | Authored from standard science reasoning after paper text review | (𝑎𝑚)𝑛 = |
| 16 | Part I | - | D | Authored from standard science reasoning after paper text review | Which is a derived unit? |
| 17 | Part I | - | D | Authored from standard science reasoning after paper text review | A boy weighing 500 newtons takes 50. seconds to climb a flight of stairs 18 meters high.... |
...
| 5 | Part I | - | A | Authored from standard science reasoning after paper text review | Artificial cleaning of blood is known as |
| 6 | Part I | - | A | Authored from standard science reasoning after paper text review | Which acid is present in vinegar? |
| 7 | Part I | - | A | Authored from standard science reasoning after paper text review | Which metal exists in fluid form at standard temperature and pressure conditions? |
| 8 | Part I | - | D | Authored from standard science reasoning after paper text review | Which one is not the contribution of Dalton in Chemistry? |
| 9 | Part I | - | A | Authored from standard science reasoning after paper text review | What is the empirical formula of Urea? |
| 10 | Part I | - | C | Authored from standard science reasoning after paper text review | Which vitamin is known as ascorbic acid? |
| 11 | Part I | - | C | Authored from standard science reasoning after paper text review | If 𝑎 ∗ b = a-b+ab, then 2 ∗ 5 + 5 ∗ 2 is |
| 12 | Part I | - | C | Authored from standard science reasoning after paper text review | Which of the fractions below is closest to 1? |
| 13 | Part I | - | D | Authored from standard science reasoning after paper text review | 62 + \|6\| + \|−6\| − 62 is equal to |
| 14 | Part I | - | B | Authored from standard science reasoning after paper text review | 55 54 |
| 15 | Part I | - | A | Authored from standard science reasoning after paper text review | (𝑎𝑚)𝑛 = |
| 16 | Part I | - | D | Authored from standard science reasoning after paper text review | Which is a derived unit? |
| 17 | Part I | - | D | Authored from standard science reasoning after paper text review | A boy weighing 500 newtons takes 50. seconds to climb a flight of stairs 18 meters high.... |
| 18 | Part I | - | A | Authored from standard science reasoning after paper text review | Which net charge could be found on an object? |
| 19 | Part I | - | B | Authored from standard science reasoning after paper text review | Compared to insulators, metals are better conductors of electricity because metals contain more free |
| 20 | Part I | - | C | Authored from standard science reasoning after paper text review | Which two quantities are measured in the same units |
| 21 | Part II | 4 | B | nstc-2022-solutions.pdf (local Google Drive source) | Which vector diagram represents the greatest magnitude of displacement for an object? |
| 22 | Part II | 4 | D | nstc-2022-solutions.pdf (local Google Drive source) | In the diagram shown on the right, two identical spheres, A and B, have equal net positive charges.... |
| 23 | Part II | 4 | C | nstc-2022-solutions.pdf (local Google Drive source) | The graph on the right shows the velocity of a race car moving along a straight line as a function of time.... |
| 24 | Part II | - | C | nstc-2022-solutions.pdf (local Google Drive source) | An archer uses a bow to fire two similar arrows with the same string force.... |
| 25 | Part II | - | D | nstc-2022-solutions.pdf (local Google Drive source) | Which is an acceptable unit for impulse? |
| 26 | Part II | - | C | nstc-2022-solutions.pdf (local Google Drive source) | During a collision, an 84-kilogram driver of a car moving at 24 meters per second is brought to rest by an inf... |
| 27 | Part II | 5 | A | nstc-2022-solutions.pdf (local Google Drive source) | A block weighing 15 newtons is pulled to the top of an incline that is 0.... |
| 28 | Part II | 5 | D | nstc-2022-solutions.pdf (local Google Drive source) | In the circuit diagram shown on the right, what are the correct readings of voltmeters V1 and V2? |
| 29 | Part II | 5 | A | nstc-2022-solutions.pdf (local Google Drive source) | A 1.0-kilogram rubber ball traveling east at 4.0 meters per second hits a wall and bounces back toward the wes... |
| 30 | Part II | 5 | A | nstc-2022-solutions.pdf (local Google Drive source) | A catapult with a spring constant of 1.0 x 10^4 newtons per meter is required to launch an airplane from the d... |
| 31 | Part II | 5 | B | nstc-2022-solutions.pdf (local Google Drive source) | Which diagram best represents magnetic flux lines around a bar magnet? |
| 32 | Part II | 5 | B | nstc-2022-solutions.pdf (local Google Drive source) | A 2.0 x 10^6 hertz radio signal is sent a distance of 7.3 x 10^10 meters from Earth to a spaceship orbiting Ma... |
| 33 | Part II | 5 | B | nstc-2022-solutions.pdf (local Google Drive source) | In which situation is the net force on the object equal to zero? |
| 34 | Part II | 5 | D | nstc-2022-solutions.pdf (local Google Drive source) | What is the total electrical energy used by a 1500-watt hair dryer operating for 6.0 minutes? |
| 35 | Part II | 5 | B | nstc-2022-solutions.pdf (local Google Drive source) | The diagram shown represents the wave pattern produced by two sources located at points A and B.... |
| 36 | Part II | 6 | D | nstc-2022-solutions.pdf (local Google Drive source) | Identical charges A, B, and C are located between two oppositely charged parallel plates, as shown in the diag... |
| 37 | Part II | 6 | A | nstc-2022-solutions.pdf (local Google Drive source) | The graph on the right represents the elongation of a spring as a function of the applied force.... |
| 38 | Part II | 6 | A | nstc-2022-solutions.pdf (local Google Drive source) | Which circuit diagram shows voltmeter V and ammeter A correctly positioned to measure the total potential diff... |
| 39 | Part II | 6 | B | nstc-2022-solutions.pdf (local Google Drive source) | The diagram below shows a 4.0-kilogram cart moving to the right and a 6.0-kilogram cart moving to the left on... |
| 40 | Part II | 6 | A | nstc-2022-solutions.pdf (local Google Drive source) | In raising an object vertically at a constant speed of 2.0 meters per second, 10 watts of power is developed.... |
| 41 | Part II | 6 | C | nstc-2022-solutions.pdf (local Google Drive source) | A light spring is attached to a heavier spring at one end. A pulse traveling along the light spring is inciden... |
| 42 | Part II | 6 | B | nstc-2022-solutions.pdf (local Google Drive source) | A wave completes one vibration as it moves a distance of 2 meters at a speed of 20 meters per second.... |
| 43 | Part II | 6 | A | nstc-2022-solutions.pdf (local Google Drive source) | Which property determines the direction of the exchange of internal energy between two objects? |
| 44 | Part II | 7 | B | nstc-2022-solutions.pdf (local Google Drive source) | What is the speed of light in a medium having an absolute index of refraction of 2.3? |
| 45 | Part II | 7 | D | nstc-2022-solutions.pdf (local Google Drive source) | Which graph best represents the relationship between the average molecular kinetic energy (𝐾𝐸̅̅̅̅ ) of an idea... |
| 46 | Part II | 7 | A | nstc-2022-solutions.pdf (local Google Drive source) | The phenomenon by which an incandescent object gives off electrons is known as |
| 47 | Part II | 7 | D | nstc-2022-solutions.pdf (local Google Drive source) | Which characteristics best describe the image produced by a plane mirror? |
| 48 | Part II | 7 | D | nstc-2022-solutions.pdf (local Google Drive source) | When an object is placed at the focal point of a concave mirror, the mirror produces |
| 49 | Part II | 7 | C | nstc-2022-solutions.pdf (local Google Drive source) | Which statement is consistent with Kepler’s laws of planetary motion? |
| 50 | Part II | 7 | D | nstc-2022-solutions.pdf (local Google Drive source) | The diagram on the right shows an electron e about to enter the region between the poles of two magnets.... |
| 51 | Part II | 7 | C | nstc-2022-solutions.pdf (local Google Drive source) | An object arrow is placed in front of a concave mirror having center of curvature C and principal focus F.... |
| 52 | Part II | 8 | C | nstc-2022-solutions.pdf (local Google Drive source) | Two coils of wire are wound around the same permeable core. Coil I has 200 turns and coil II has 3000 turns.... |
| 53 | Part II | 8 | C | nstc-2022-solutions.pdf (local Google Drive source) | A man is standing on a set of bathroom scales, measuring his weight, in an elevator.... |
| 54 | Part II | 8 | B | nstc-2022-solutions.pdf (local Google Drive source) | The speed of light in vacuum, 𝑐, depends on two fundamental constants, the permeability of free space, 𝜇0, and... |
| 55 | Part II | 8 | B | nstc-2022-solutions.pdf (local Google Drive source) | Which two graphs represent the motion of an object on which the net force is zero? |
| 56 | Part II | 8 | C | nstc-2022-solutions.pdf (local Google Drive source) | A large bus and a small car collide and stick together. Which one undergoes the larger change in momentum? |
| 57 | Part II | 8 | B | nstc-2022-solutions.pdf (local Google Drive source) | An electrostatic force of magnitude F exists between two metal spheres having identical charge q.... |
| 58 | Part II | 8 | D | nstc-2022-solutions.pdf (local Google Drive source) | A physics student is given three 12-ohm resistors with instructions to create the circuit that would have the... |
| 59 | Part II | 9 | A | nstc-2022-solutions.pdf (local Google Drive source) | What occurs when light passes from water into flint glass? |
| 60 | Part II | 9 | A | nstc-2022-solutions.pdf (local Google Drive source) | Two points on a transverse wave that have the same magnitude of displacement from equilibrium are in phase if... |
| 61 | Part II | 9 | C | nstc-2022-solutions.pdf (local Google Drive source) | The diagram on the right represents the path of Earth around the Sun. As Earth travels in its orbit from its J... |
| 62 | Part II | 9 | A | nstc-2022-solutions.pdf (local Google Drive source) | A temperature change of 20 Celsius degrees is equal to a temperature change of |
| 63 | Part II | 9 | B | nstc-2022-solutions.pdf (local Google Drive source) | The diagram on the right shows a circuit with a battery applying a potential difference across an N-type semic... |
| 64 | Part II | 9 | C | nstc-2022-solutions.pdf (local Google Drive source) | If nitrogen nuclei are bombarded with alpha particles they can be changed into oxygen nuclei.... |
| 65 | Part II | 9 | B | nstc-2022-solutions.pdf (local Google Drive source) | Which device can be used to detect subatomic particles that exit nuclei? |
| 66 | Part II | 9 | A | nstc-2022-solutions.pdf (local Google Drive source) | If the nucleus of an atom emits a positron, the atomic number of the atom will |
| 67 | Part II | 9 | D | nstc-2022-solutions.pdf (local Google Drive source) | The half-life of a particular radioactive material is 6.0 hours. What fraction of a sample of the material wou... |
| 68 | Part II | 10 | D | nstc-2022-solutions.pdf (local Google Drive source) | In a working transistor circuit, as the emitter-base current is increased, the collector current |
| 69 | Part II | 10 | C | nstc-2022-solutions.pdf (local Google Drive source) | Spherical aberration is a defect associated with |
| 70 | Part II | 10 | C | nstc-2022-solutions.pdf (local Google Drive source) | If the current in an ammeter’s coil is doubled, the resulting torque on the coil will be |

## NSTC 2023 Biology Paper

| No. | Section | Page | Answer | Source | Prompt |
| --- | --- | --- | --- | --- | --- |
| 1 | Part I | - | C | Authored from standard science reasoning after paper text review | During cellular respiration breakdown of glucose occurs in |
| 2 | Part I | - | D | Authored from standard science reasoning after paper text review | The hypothesis that stands the test of time are called |
| 3 | Part I | - | B | Authored from standard science reasoning after paper text review | Cancer is disease of |
| 4 | Part I | - | C | Authored from standard science reasoning after paper text review | A conjugate acid is a specie formed by accepting a |
| 5 | Part I | - | C | Authored from standard science reasoning after paper text review | In which phase of Meiosis the homologous chromosomes separated from each other |
| 6 | Part I | - | D | Authored from standard science reasoning after paper text review | All of the following substance are crystalline except |
| 7 | Part I | - | C | Authored from standard science reasoning after paper text review | Diameter of an atom in the order of |
| 8 | Part I | - | D | Authored from standard science reasoning after paper text review | Which of the following is not a macromolecule |
| 9 | Part I | - | D | Authored from standard science reasoning after paper text review | About how many elements in the Periodic Table are Metals |
| 10 | Part I | - | D | Authored from standard science reasoning after paper text review | Plasma is used in |
| 11 | Part I | - | B | Authored from standard science reasoning after paper text review | The distance between the points (-2, 2) and (1, 6) is |
| 12 | Part I | - | A | Authored from standard science reasoning after paper text review | Angles that sum up to 90 ° are known as |
| 13 | Part I | - | D | Authored from standard science reasoning after paper text review | Total number of lines passing through the point (0,0) are |
| 14 | Part I | - | B | Authored from standard science reasoning after paper text review | The coordinates of the midpoint of points in plane with coordinates (−2,8) and (8, −2) is |
| 15 | Part I | - | D | Authored from standard science reasoning after paper text review | If 𝑥 + 1 𝑥 = 2, then the value of 𝑥2 + 1 𝑥2 is |
| 16 | Part I | - | B | Authored from standard science reasoning after paper text review | A net force of 10. Newtons accelerates an object at 5.0 m/s 2. What net force would be required to accelerate... |
| 17 | Part I | - | D | Authored from standard science reasoning after paper text review | A 1,200-kilogram car traveling at 10. m/s hits a tree and is brought to rest in 0.10 second.... |
...
| 12 | Part I | - | A | Authored from standard science reasoning after paper text review | Angles that sum up to 90 ° are known as |
| 13 | Part I | - | D | Authored from standard science reasoning after paper text review | Total number of lines passing through the point (0,0) are |
| 14 | Part I | - | B | Authored from standard science reasoning after paper text review | The coordinates of the midpoint of points in plane with coordinates (−2,8) and (8, −2) are |
| 15 | Part I | - | D | Authored from standard science reasoning after paper text review | If 𝑥 + 1 𝑥 = 2, then the value of 𝑥2 + 1 𝑥2 is |
| 16 | Part I | - | B | Authored from standard science reasoning after paper text review | A net force of 10. Newtons accelerates an object at 5.0 m/s 2. What net force would be required to accelerate... |
| 17 | Part I | - | D | Authored from standard science reasoning after paper text review | A 1,200-kilogram car traveling at 10. m/s hits a tree and is brought to rest in 0.10 second.... |
| 18 | Part I | - | A | Authored from standard science reasoning after paper text review | When a neutral metal sphere is charged by contact with a positively charged glass rod, the sphere |
| 19 | Part I | - | D | Authored from standard science reasoning after paper text review | An electric iron operating at 120 volts draws 10. Amperes of current. How much heat energy is delivered by the... |
| 20 | Part I | - | C | Authored from standard science reasoning after paper text review | A radar gun can determine the speed of a moving automobile by measuring the difference in frequency between em... |
| 21 | Part II | - | C | nstc-2023-solutions.pdf (local Google Drive source) | A 70.-kilogram cyclist develops 210 watts of power while pedaling at a constant velocity of 7.... |
| 22 | Part II | - | B | nstc-2023-solutions.pdf (local Google Drive source) | The gravitational potential energy, with respect to Earth, that is possessed by an object is dependent on the... |
| 23 | Part II | - | B | nstc-2023-solutions.pdf (local Google Drive source) | Which phenomenon provides evidence that light has a wave nature? |
| 24 | Part II | - | D | nstc-2023-solutions.pdf (local Google Drive source) | When Earth and the Moon are separated by a distance of 3.84 x 10^8 meters, the magnitude of the gravitational... |
| 25 | Part II | 4 | D | nstc-2023-solutions.pdf (local Google Drive source) | The graph represents the motion of a car during a 6.0-second time interval.... |
| 26 | Part II | - | D | nstc-2023-solutions.pdf (local Google Drive source) | A motorcycle being driven on a dirt path hits a rock. Its 60. -kilogram cyclist is projected over the handleba... |
| 27 | Part II | 4 | C | nstc-2023-solutions.pdf (local Google Drive source) | Which combination of resistors has the smallest equivalent resistance? |
| 28 | Part II | 4 | A | nstc-2023-solutions.pdf (local Google Drive source) | A constant potential difference is applied across a variable resistor held at constant temperature.... |
| 29 | Part II | - | B | nstc-2023-solutions.pdf (local Google Drive source) | The current traveling from the cathode to the screen in a television picture tube is 5.0 × 10–5 ampere.... |
| 30 | Part II | - | A | nstc-2023-solutions.pdf (local Google Drive source) | As a sound wave passes from water, where the speed is 1.49 x 10^3 meters per second, into air, the wave’s spee... |
| 31 | Part II | 4 | C | nstc-2023-solutions.pdf (local Google Drive source) | The diagram below represents an electric circuit consisting of a 12-volt battery, a 3.... |
| 32 | Part II | 5 | D | nstc-2023-solutions.pdf (local Google Drive source) | A single vibratory disturbance moving through a medium is called |
| 33 | Part II | 5 | C | nstc-2023-solutions.pdf (local Google Drive source) | A source of waves and an observer are moving relative to each other. The observer will detect a steadily incre... |
| 34 | Part II | 5 | C | nstc-2023-solutions.pdf (local Google Drive source) | A wave is diffracted as it passes through an opening in a barrier. The amount of diffraction that the wave und... |
| 35 | Part II | 5 | D | nstc-2023-solutions.pdf (local Google Drive source) | The diagram on right represents two waves of equal amplitude and frequency approaching point P as they move th... |
| 36 | Part II | 5 | D | nstc-2023-solutions.pdf (local Google Drive source) | A constant unbalanced force is applied to an object for a period of time.... |
| 37 | Part II | 5 | B | nstc-2023-solutions.pdf (local Google Drive source) | The graph below represents the kinetic energy, gravitational potential energy, and total mechanical energy of... |
| 38 | Part II | 5 | D | nstc-2023-solutions.pdf (local Google Drive source) | Which graph best represents the relationship between the magnitude of the electric field strength, E, around a... |
| 39 | Part II | 5 | B | nstc-2023-solutions.pdf (local Google Drive source) | The force required to start an object sliding across a uniform horizontal surface is larger than the force req... |
| 40 | Part II | 6 | A | nstc-2023-solutions.pdf (local Google Drive source) | A laser beam is directed at the surface of a smooth, calm pond as represented in the diagram below.... |
| 41 | Part II | 6 | B | nstc-2023-solutions.pdf (local Google Drive source) | An immersion heater has a resistance of 5.0 ohms while drawing a current of 3.0 amperes.... |
| 42 | Part II | 6 | B | nstc-2023-solutions.pdf (local Google Drive source) | Ball A of mass 5.0 kilograms moving at 20. meters per second collides with ball B of unknown mass moving at 10... |
| 43 | Part II | 6 | D | nstc-2023-solutions.pdf (local Google Drive source) | Identical resistors (R) are connected across the same 12-volt battery. Which circuit uses the greatest power? |
| 44 | Part II | 6 | C | nstc-2023-solutions.pdf (local Google Drive source) | Which graph best represents the motion of an object that is not in equilibrium as it travels along a straight... |
| 45 | Part II | 6 | D | nstc-2023-solutions.pdf (local Google Drive source) | Standing waves in water are produced most often by periodic water waves |
| 46 | Part II | 6 | B | nstc-2023-solutions.pdf (local Google Drive source) | A change in the speed of a wave as it enters a new medium produces a change in |
| 47 | Part II | 6 | D | nstc-2023-solutions.pdf (local Google Drive source) | Oil droplets may gain electrical charges as they are projected through a nozzle.... |
| 48 | Part II | 6 | B | nstc-2023-solutions.pdf (local Google Drive source) | A 15.0-kilogram mass is moving at 7.50 m/s on a horizontal, frictionless surface.... |
| 49 | Part II | 6 | A | nstc-2023-solutions.pdf (local Google Drive source) | A child throws a ball toward the front end of an approaching train. The collision between the ball and the tra... |
| 50 | Part II | 6 | D | nstc-2023-solutions.pdf (local Google Drive source) | A physics textbook of mass m rests flat on a horizontal table of mass M placed on the ground.... |
| 51 | Part II | 6 | D | nstc-2023-solutions.pdf (local Google Drive source) | A simple pendulum of length L with a bob of mass m is taken into Earth orbit on the International Space Statio... |
| 52 | Part II | 7 | B | nstc-2023-solutions.pdf (local Google Drive source) | A projectile is launched with an initial velocity 𝑣𝑖, with 𝑣𝑖𝑥 and 𝑣𝑖𝑦 the horizontal and vertical velocity co... |
| 53 | Part II | 7 | C | nstc-2023-solutions.pdf (local Google Drive source) | As more and more negative electric charge is being brought to a conducting sphere, inside the sphere |
| 54 | Part II | 7 | B | nstc-2023-solutions.pdf (local Google Drive source) | A string of length L is composed of two segments of equal length. One segment has linear mass density 𝜇1 and t... |
| 55 | Part II | 7 | C | nstc-2023-solutions.pdf (local Google Drive source) | A perfectly straight portion of a uniform rope has mass M and length L. At end A of the segment, the tension i... |
| 56 | Part II | 7 | A | nstc-2023-solutions.pdf (local Google Drive source) | Two spheres are identical except that sphere A is white whereas sphere B is black.... |
| 57 | Part II | 7 | C | nstc-2023-solutions.pdf (local Google Drive source) | Why does a raindrop fall with near-constant speed during the later stages of its descent? |
| 58 | Part II | 7 | B | nstc-2023-solutions.pdf (local Google Drive source) | A glass-walled elevator is moving upwards with constant acceleration. At some point in the elevator’s motion... |
| 59 | Part II | 7 | D | nstc-2023-solutions.pdf (local Google Drive source) | The Earth and the Moon both exert gravitational forces on objects in their vicinity.... |
| 60 | Part II | 7 | B | nstc-2023-solutions.pdf (local Google Drive source) | A ball is held at a height H above a floor, as sketched in the diagram on the right.... |
| 61 | Part II | 8 | C | nstc-2023-solutions.pdf (local Google Drive source) | Some students are doing an experiment to calculate the spring constant of a particular spring.... |
| 62 | Part II | 8 | B | nstc-2023-solutions.pdf (local Google Drive source) | A roller-coaster car is full of water, and is moving at constant velocity along a frictionless horizontal trac... |
| 63 | Part II | 8 | D | nstc-2023-solutions.pdf (local Google Drive source) | The velocity of a particle moving along the x-axis changes from vi to vf .... |
| 64 | Part II | 8 | D | nstc-2023-solutions.pdf (local Google Drive source) | An introductory physics student, elated by a first semester grade, celebrates by dropping a textbook from a ba... |
| 65 | Part II | 8 | C | nstc-2023-solutions.pdf (local Google Drive source) | A mass on a frictionless table is attached to the midpoint of an originally unstretched spring fixed at the en... |
| 66 | Part II | 8 | B | nstc-2023-solutions.pdf (local Google Drive source) | Kepler's Laws state that 1 the orbits of planets are elliptical with one focus at the sun, II.... |
| 67 | Part II | 8 | D | nstc-2023-solutions.pdf (local Google Drive source) | Two blocks are suspended by two massless elastic strings to the ceiling as shown in the figure.... |
| 68 | Part II | 8 | C | nstc-2023-solutions.pdf (local Google Drive source) | A ball rolls from the back of a large truck traveling 10.0 m/s to the right.... |
| 69 | Part II | 9 | C | nstc-2023-solutions.pdf (local Google Drive source) | A block foats partially submerged in a container of liquid. When the entire container is accelerated upward, w... |
| 70 | Part II | 9 | C | nstc-2023-solutions.pdf (local Google Drive source) | An object is released from rest and falls a distance h during the first second of time.... |

## NSTC 2024 Biology Paper

| No. | Section | Page | Answer | Source | Prompt |
| --- | --- | --- | --- | --- | --- |
| 1 | Part I | - | D | Authored from standard science reasoning after paper text review | During cellular respiration breakdown of glucose occurs in |
| 2 | Part I | - | D | Authored from standard science reasoning after paper text review | The following rays can cause cancer |
| 3 | Part I | - | D | Authored from standard science reasoning after paper text review | The hypothesis that stands the test of time are called |
| 4 | Part I | - | A | Authored from standard science reasoning after paper text review | Electric intensity is a |
| 5 | Part I | - | D | Authored from standard science reasoning after paper text review | One coulomb is equal to the charge of------------------------electrons. |
| 6 | Part I | - | A | Authored from standard science reasoning after paper text review | The phenomenon of emission of light in a chemical reaction is known as |
| 7 | Part I | - | B | Authored from standard science reasoning after paper text review | Name the device used to measure the number of nuclear disintegration per minute |
| 8 | Part I | - | C | Authored from standard science reasoning after paper text review | Which of the following bonds must be present in alkynes? |
| 9 | Part I | - | C | Authored from standard science reasoning after paper text review | When a solution contains equal concentration of hydroxyl and hydrogen ions its pH will be around |
| 10 | Part I | - | A | Authored from standard science reasoning after paper text review | Which is the most reactive element in the given list? |
| 11 | Part I | - | D | Authored from standard science reasoning after paper text review | A quadrilateral with vertices at ( ) ( ) ( ) ( )0, –1 , 3,1 , 3, 1 , 0,1- is a __________. |
| 12 | Part I | - | C | Authored from standard science reasoning after paper text review | The center of the circle, __________. |
| 13 | Part I | - | B | Authored from standard science reasoning after paper text review | What is the sum of all the divisors of 600? |
| 14 | Part I | - | A | Authored from standard science reasoning after paper text review | What is the sum of the first nine prime numbers? |
| 15 | Part I | - | A | Authored from standard science reasoning after paper text review | The equations 2x+7=3 and bx - 10 = -2 have the same solution. What is the value of b? |
| 16 | Part I | - | A | Authored from standard science reasoning after paper text review | A ball of mass m falls from rest onto a floor, from a height h. It makes elastic collisions with the floor rep... |
| 17 | Part I | - | C | Authored from standard science reasoning after paper text review | While passing over an obstacle a light ray slightly bends round the corner. The phenomenon is known as__ |
...
| 19 | Part I | - | B | Authored from standard science reasoning after paper text review | What is the direction of electric and magnetic fields in an electromagnetic wave? |
| 20 | Part I | - | D | Authored from standard science reasoning after paper text review | What is the time period of a seconds pendulum? |
| 21 | Part II | - | B | nstc-2024-solutions.pdf (local Google Drive source) | Consider a car starts moving from rest with acceleration 𝑎 = 10.0 𝑚/𝑠2, then continues uniformly, and finally... |
| 22 | Part II | - | A | nstc-2024-solutions.pdf (local Google Drive source) | A particle has a radius vector which varies with time t as 𝑟⃗⃗ = (1 − 𝛽𝑡)𝑡𝑟𝑜⃗⃗⃗ , where 𝑟𝑜⃗⃗⃗ is a constant ve... |
| 23 | Part II | - | D | nstc-2024-solutions.pdf (local Google Drive source) | Use the information in question 22. Let the particle starts at 𝑡 = 0 and returns back to its original position... |
| 24 | Part II | - | D | nstc-2024-solutions.pdf (local Google Drive source) | Consider a mass slides on a horizontal frictionless track. It is connected to a spring fastened to a wall.... |
| 25 | Part II | - | C | nstc-2024-solutions.pdf (local Google Drive source) | Consider a block of mass 1.0 kg is moving with a velocity v. It collides with a block of mass 6.... |
| 26 | Part II | - | B | nstc-2024-solutions.pdf (local Google Drive source) | A particle is placed 10 cm from the center of a rough turntable. The turntable is steadily accelerated at 20 r... |
| 27 | Part II | - | C | nstc-2024-solutions.pdf (local Google Drive source) | Consider a solid cylinder of uniform density having mass M and radius R. A string of length L is completely wo... |
| 28 | Part II | - | B | nstc-2024-solutions.pdf (local Google Drive source) | Consider a block of mass M sliding on a frictionless surface of ice at a uniform velocity of 20 m/s.... |
| 29 | Part II | - | A | nstc-2024-solutions.pdf (local Google Drive source) | Consider a spring-mass system with oscillation frequency f. What is the new frequency of the oscillator if the... |
| 30 | Part II | - | D | nstc-2024-solutions.pdf (local Google Drive source) | A uniform mass density cylinder of radius r and mass m rolls down a ramp of length d and height h.... |
| 31 | Part II | - | A | nstc-2024-solutions.pdf (local Google Drive source) | What is the recoil velocity of a rifle of mass 5.0 kg, if a bullet of mass 0.... |
| 32 | Part II | - | A | nstc-2024-solutions.pdf (local Google Drive source) | A tennis ball is thrown vertically upward from the top of a pole of height 30.0 m (from ground) at time 𝑡 = 0.... |
| 33 | Part II | 5 | B | nstc-2024-solutions.pdf (local Google Drive source) | Consider the launch of a rocket carrying satellite. After 1.2 s of liftoff, it clears the top of its launch pl... |
| 34 | Part II | 5 | A | nstc-2024-solutions.pdf (local Google Drive source) | Consider an old building is blown using dynamite by a demolition team. Assume that the explosion results in de... |
| 35 | Part II | 5 | D | nstc-2024-solutions.pdf (local Google Drive source) | A physical pendulum performs small oscillations about the horizontal axis with a frequency 𝜔1 = 15.0𝑠−1.... |
| 36 | Part II | 5 | C | nstc-2024-solutions.pdf (local Google Drive source) | Consider an airliner is flying at angle 𝜃 = 26.0𝑜 above the horizontal with velocity 𝑣 = 80.0𝑚 𝑠⁄ .... |
| 37 | Part II | 5 | D | nstc-2024-solutions.pdf (local Google Drive source) | A car is moving in a straight line with a velocity 110 km/h. If brakes are applied and maximum deceleration is... |
| 38 | Part II | 5 | B | nstc-2024-solutions.pdf (local Google Drive source) | A tennis ball initially at rest is dropped from a height h into a pond. It touches the water surface in 4 seco... |
| 39 | Part II | 5 | D | nstc-2024-solutions.pdf (local Google Drive source) | Consider an airplane flying with a constant velocity of 550 km/h at a constant height of 3 km.... |
| 40 | Part II | 5 | A | nstc-2024-solutions.pdf (local Google Drive source) | Consider a mass M = 2 kg placed on a smooth table and is attached by a massless string and a frictionless pull... |
| 41 | Part II | 5 | D | nstc-2024-solutions.pdf (local Google Drive source) | Consider a wooden block of mass m1 connected with an elastic spring of spring constant k.... |
| 42 | Part II | 5 | B | nstc-2024-solutions.pdf (local Google Drive source) | A mass of 1.0 kg is attached to a string and is rotated in a vertical orbit of radius 1.0 m.... |
| 43 | Part II | 5 | C | nstc-2024-solutions.pdf (local Google Drive source) | The angular speed of the minute hand of a watch is |
| 44 | Part II | 5 | D | nstc-2024-solutions.pdf (local Google Drive source) | Assume we have a pendulum clock which gives correct time on earth surface.... |
| 45 | Part II | 5 | A | nstc-2024-solutions.pdf (local Google Drive source) | The amplitude of oscillation of a simple pendulum is increased from 2o to 6o.... |
| 46 | Part II | 6 | A | nstc-2024-solutions.pdf (local Google Drive source) | Consider a vibration sensitive equipment of mass 1.0 kg is being transported in a box of mass 4.0 kg.... |
| 47 | Part II | 6 | C | nstc-2024-solutions.pdf (local Google Drive source) | A 12 m long pendulum initially hanging at equilibrium is given a velocity of 0.3 m/s.... |
| 48 | Part II | 6 | B | nstc-2024-solutions.pdf (local Google Drive source) | An ideal spring is suspended in a vertical position from the ceiling. If a mass of 2.... |
| 49 | Part II | 6 | B | nstc-2024-solutions.pdf (local Google Drive source) | Approximately how many swings a pendulum of length 2.25 m perform in one hour? |
| 50 | Part II | 6 | C | nstc-2024-solutions.pdf (local Google Drive source) | What is the period of oscillation of a 1.0 kg mass attached to a spring lying on a smooth horizontal table if... |
| 51 | Part II | 6 | C | nstc-2024-solutions.pdf (local Google Drive source) | Suppose there is a light source whose power is P = 40 W. A student is standing at a distance of 10 m from this... |
| 52 | Part II | 6 | B | nstc-2024-solutions.pdf (local Google Drive source) | A vessel is divided into two parts of equal volume by a partition in which there is a very small hole.... |
| 53 | Part II | 6 | C | nstc-2024-solutions.pdf (local Google Drive source) | The plates of a parallel-plate capacitor of area 10−2m2are separated by a distance of 10mm.... |
| 54 | Part II | 6 | D | nstc-2024-solutions.pdf (local Google Drive source) | Consider a block of mass 12kg is moving towards east at 4 meters per second.... |
| 55 | Part II | 6 | C | nstc-2024-solutions.pdf (local Google Drive source) | A particle initially at rest explodes into three equal-mass particles in a situation where no external forces... |
| 56 | Part II | 6 | D | nstc-2024-solutions.pdf (local Google Drive source) | A ball of mass m = 0.5 kg is attached to the end of a string of length L = 0.5 m.... |
| 57 | Part II | 6 | C | nstc-2024-solutions.pdf (local Google Drive source) | A car is moving in a circular horizontal track of radius 10 m with a constant speed of 10 m/s.... |
| 58 | Part II | 7 | C | nstc-2024-solutions.pdf (local Google Drive source) | Alice stands 20 m from a wall and Bob stands 10 m from the same wall. Alice throws a ball at an angle of 30o a... |
| 59 | Part II | 7 | C | nstc-2024-solutions.pdf (local Google Drive source) | A sportsman leaps into the air and catches a ball while both are in midair.... |
| 60 | Part II | 7 | D | nstc-2024-solutions.pdf (local Google Drive source) | If we compare a photon of red light with a photon of blue light, the photon of blue light has a |
| 61 | Part II | 7 | D | nstc-2024-solutions.pdf (local Google Drive source) | A 1.5 kilogram lab cart is accelerated uniformly from rest to a speed of 2.0 meters per second in 0.50 second.... |
| 62 | Part II | 7 | A | nstc-2024-solutions.pdf (local Google Drive source) | If the momentum of object with different masses is same. Then the object having largest K.... |
| 63 | Part II | 7 | C | nstc-2024-solutions.pdf (local Google Drive source) | A man weights 735 N is in a stationary lift. What will be his weight if the lift starts moving up with an acce... |
| 64 | Part II | 7 | D | nstc-2024-solutions.pdf (local Google Drive source) | In a downward moving elevator having an acceleration of 9.8ms-2, the mass of a person will |
| 65 | Part II | 7 | D | nstc-2024-solutions.pdf (local Google Drive source) | Keeping the temperature of the ideal gas constant, if the pressure is doubled than the speed of sound will be |
| 66 | Part II | 7 | C | nstc-2024-solutions.pdf (local Google Drive source) | The power of lens is measured in |
| 67 | Part II | 7 | B | nstc-2024-solutions.pdf (local Google Drive source) | The chemical properties of all isotopes are |
| 68 | Part II | 7 | B | nstc-2024-solutions.pdf (local Google Drive source) | The internal energy of an ideal gas depends upon only |
| 69 | Part II | 7 | A | nstc-2024-solutions.pdf (local Google Drive source) | A bus is moving on a straight road with uniform acceleration. Marker posts are placed at 100m apart along the... |
| 70 | Part II | 7 | C | nstc-2024-solutions.pdf (local Google Drive source) | In an experiment to determine the density of a steel ball, the uncertainty in the measurement of its mass was... |

## NSTC 2025 Biology Paper

| No. | Section | Page | Answer | Source | Prompt |
| --- | --- | --- | --- | --- | --- |
| 1 | Part I | 2 | A | Authored from standard science reasoning after paper text review | Which gas is flled in an electric bulb? |
| 2 | Part I | 2 | B | Authored from standard science reasoning after paper text review | Cancer is disease of: |
| 3 | Part I | 2 | D | Authored from standard science reasoning after paper text review | Which of the following is a list of entirely abiotic factors? |
| 4 | Part I | 2 | B | Authored from standard science reasoning after paper text review | Malaria is an infectious disease caused by a single-celled eukaryotic organism, carried by female mosquitoes.... |
| 5 | Part I | 2 | A | Authored from standard science reasoning after paper text review | Cellular digestion is associated with which organelle? |
| 7 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Adrop of liquidacquiresa spherical shape because of |
| 8 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Some pcople add sodium chloride to water whileboiling eggs. This is to |
| 9 | Part I | 3 | D | Authored from standard science reasoning after paper text review | Avariety ofwater which contains soluble salts of Ca and Mg is known as |
| 11 | Part I | 3 | B | Authored from standard science reasoning after paper text review | I1.Ifx+1/x=3,then thevalueofx+1/xis: |
| 12 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Findthedegree of the polynonial 5x'y?+3xy'+7? |
| 14 | Part I | 3 | B | Authored from standard science reasoning after paper text review | If x2-6x+9=0, thex = |
...
| No. | Section | Page | Answer | Source | Prompt |
| --- | --- | --- | --- | --- | --- |
| 1 | Part I | 3 | A | Authored from standard science reasoning after paper text review | Which gas is filled in an electric bulb? |
| 2 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Cancer is disease of: |
| 3 | Part I | 3 | D | Authored from standard science reasoning after paper text review | Which ofthe following is a list of entirely abiotic factors? |
| 4 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Malaria is an infectious disease caused by a single-celledeukaryotic organism,carried byfemale mosquitoes.... |
| 5 | Part I | 3 | A | Authored from standard science reasoning after paper text review | Cellulardigestion is associatedwith which organelle? |
| 7 | Part I | 4 | B | Authored from standard science reasoning after paper text review | Adrop of liquid acquires a spherical shape because of: |
| 8 | Part I | 4 | B | Authored from standard science reasoning after paper text review | Some people add sodium chloride to water whileboiling eggs.This is to? |
| 9 | Part I | 4 | D | Authored from standard science reasoning after paper text review | Avaricty of water which contains soluble salts of Ca and Mg is known as: |
| 10 | Part I | 4 | A | Authored from standard science reasoning after paper text review | Milk is a colloid in which? |
| 11 | Part I | 4 | B | Authored from standard science reasoning after paper text review | If x+1/x=3,then thevalue ofx?+1/x2is: |
| 12 | Part I | 4 | B | Authored from standard science reasoning after paper text review | Find the degree of the polynomial 5xy?+3xy5+ 7? |
| 13 | Part I | 4 | B | Authored from standard science reasoning after paper text review | Number of real roots of x2 + 4x + 5 = 0 is: |
| 14 | Part I | 4 | B | Authored from standard science reasoning after paper text review | If x2 - 6x + 9 = 0, the x = |
| 15 | Part I | 4 | B | Authored from standard science reasoning after paper text review | The set of all points, in a plane equidistant from a fixed point A = (x,y),forms a |
| 16 | Part I | 4 | D | Authored from standard science reasoning after paper text review | A 1,200-kilogram car traveling at 10 meters per second hits a tree and is brought to rest in 0.10 second.... |
| 17 | Part I | 4 | B | Authored from standard science reasoning after paper text review | A spring scale reads 20 newtons as it pulls a 5.0-kilogram mass across a table.... |
...
| No. | Section | Page | Answer | Source | Prompt |
| --- | --- | --- | --- | --- | --- |
| 1 | Part I | 2 | A | Authored from standard science reasoning after paper text review | Whichgas is filled in an electricbulb? |
| 2 | Part I | 2 | B | Authored from standard science reasoning after paper text review | Canceris disease of: |
| 3 | Part I | 2 | D | Authored from standard science reasoning after paper text review | Which ofthe following is a list of entirely abiotic factors? |
| 4 | Part I | 2 | B | Authored from standard science reasoning after paper text review | Malaria is an infectious discase caused by a single-celled eukaryotic organism, carried by female mosquitoes.... |
| 5 | Part I | 2 | A | Authored from standard science reasoning after paper text review | Cellular digestion is associated with which organelle? |
| 7 | Part I | 3 | B | Authored from standard science reasoning after paper text review | A drop of liquid acquires a spherical shape because of |
| 8 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Some people add sodium chloride to water whileboiling eggs.This is to |
| 9 | Part I | 3 | D | Authored from standard science reasoning after paper text review | Avariety of waterwhich contains soluble salts of Ca and Mg is known as |
| 10 | Part I | 3 | A | Authored from standard science reasoning after paper text review | Milk is a colloid in which |
| 11 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Ifx+1/x=3,thenthevalueofx?+1/xis: |
| 12 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Findthedegreeofthepolynomial5xy2+3xy5+7? |
| 13 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Number of real roots of x2 + 4x + 5 = 0 is: |
| 14 | Part I | 3 | B | Authored from standard science reasoning after paper text review | If x2 - 6x + 9 = 0, the x = |
| 15 | Part I | 3 | B | Authored from standard science reasoning after paper text review | The setofall points, in a planeequidistant from a fixed point A =(x,y),foms a |
| 16 | Part I | 3 | D | Authored from standard science reasoning after paper text review | AI,200-kilogram car traveling at10meters per second hits a tree and is brought to rest in 0.10 second.... |
| 17 | Part I | 3 | B | Authored from standard science reasoning after paper text review | A spring scale reads 20 newtons as it pulls a 5.0-kilogram mass across a table.... |
| 18 | Part I | 3 | A | Authored from standard science reasoning after paper text review | When a neutral metal sphere is charged by contact with a positively charged glass rod, the sphere |
...
| No. | Section | Page | Answer | Source | Prompt |
| --- | --- | --- | --- | --- | --- |
| 1 | Part I | 2 | A | Authored from standard science reasoning after paper text review | Which gas is filled in electricbulb? |
| 2 | Part I | 2 | B | Authored from standard science reasoning after paper text review | Cancer is disease of: |
| 3 | Part I | 2 | D | Authored from standard science reasoning after paper text review | Which of the following is a list of entirely abiotic factors? |
| 4 | Part I | 2 | B | Authored from standard science reasoning after paper text review | Malaria is an infectious disease caused by a single-celled eukaryotic organism, caried by female mosquitoes.... |
| 5 | Part I | 2 | A | Authored from standard science reasoning after paper text review | Cellular digestion is associated with which organelle? |
| 7 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Adrop of liquid acquires a spherical shapebecause of |
| 8 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Some people add sodium chloride to water while boiling eggs. This is to |
| 9 | Part I | 3 | D | Authored from standard science reasoning after paper text review | Avarictyofwaterwhichcontains solublesalts of Caand Mgisknownas |
| 10 | Part I | 3 | A | Authored from standard science reasoning after paper text review | Milk is a colloid in which |
| 11 | Part I | 3 | B | Authored from standard science reasoning after paper text review | If× + 1/x = 3, then the value ofx?+1/x2 is: |
| 12 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Find the degree of the polynomial 5xy? + 3xy5+7? |
| 13 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Number of real roots of x? + 4x + 5 = 0 is: |
| 14 | Part I | 3 | B | Authored from standard science reasoning after paper text review | Ifx2-6x+9=0,the x= |
| 15 | Part I | 3 | B | Authored from standard science reasoning after paper text review | The set ofall points, in a plane equidistance from a fix point A = (x,y),forms a |
| 16 | Part I | 3 | D | Authored from standard science reasoning after paper text review | A1,200-kilogram car traveling at 10 meters per second hits a tree and is brought to rest in 0.10 second.... |
| 17 | Part I | 3 | B | Authored from standard science reasoning after paper text review | forceexertedbythemass on the spring scale? |
| 18 | Part I | 3 | A | Authored from standard science reasoning after paper text review | When a neutral metal sphere is charged by contact with a positively charged glass rod, the sphere |
| 19 | Part I | 3 | D | Authored from standard science reasoning after paper text review | A motor is used to produce 4.0 waves each second in a string. What is the frequency of the waves? |
| 20 | Part I | 3 | D | Authored from standard science reasoning after paper text review | One watt is equivalent to one |
